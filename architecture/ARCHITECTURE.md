...
Игрок начинает очки опыта, когда убивает врагов. При наборе определенного числа очков опыта игрок переходит 
на следующий уровень, что означает улучшение его характеристики: число жизней, а так же число ходов между возможностью использовать инвентарь конфузии заново.
