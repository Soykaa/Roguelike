...
с архитектурным стилем **MVC**, однако для обработки ввода была выделена отдельная компонента для достижения большей 
платформонезависимости остальных частей.
