...
/**
 * Represents commands, connected with game screen displaying, with complicated logic.
 **/
public class GameMacroCommand implements MacroCommand {
    ...
    /**
     * Creates new GameMacroCommand instance.
     *
     ...
     * @return corresponding screen (game or menu)
     **/
    @Override
